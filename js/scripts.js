...
function toggleWhyAndroid() {
  ...
  if(isClosed.length > 0) {
    ...
    document.getElementsByClassName('why-android-expand')[0].setAttribute('class', 'fa fa-caret-up fa-3x why-android-expand-open');
    ...
    document.getElementsByClassName('menu-list-label')[0].setAttribute('class', 'menu-list-label');
    document.getElementsByClassName('why-android-expand-open')[0].setAttribute('class', 'fa fa-caret-down fa-3x why-android-expand');
  }
}
