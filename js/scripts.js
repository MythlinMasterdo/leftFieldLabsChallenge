...
function toggleWhyAndroid() {
  ...
  if(isClosed.length > 0) {
    ...
    document.getElementsByClassName('why-android-expand')[0].setAttribute('class', 'fa fa-caret-up why-android-expand-open');
    ...
    document.getElementsByClassName('why-android-expand-open')[0].setAttribute('class', 'fa fa-caret-down why-android-expand');
  }
}
